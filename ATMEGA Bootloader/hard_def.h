...
enum mcp23017_gpb
{
	...
	GPB1				= 1<<1,	// GPB1
	GPB2				= 1<<2,	// GPB2
	DRIVE_DIGIT_4		= 1<<3, // GPB3
	DRIVE_DIGIT_3		= 1<<4, // GPB4
	DRIVE_DIGIT_2		= 1<<5,	// GPB5
	DRIVE_DIGIT_1		= 1<<6,	// GPB6
	REFERENCE_ENABLE	= 1<<7, // GPB7	
};


/* MACROS */
#define SGF(BIT)		(System.GF |=  (1<<BIT)) // set global flag
#define CGF(BIT)		(System.GF &= ~(1<<BIT)) // clear global flag
#define GGF(   )		(System.GF)			// get global flag

#define SUF(BIT)		(UART.UF |=  (1<<BIT))	 // set uart flag
#define CUF(BIT)		(UART.UF &= ~(1<<BIT))	 // clear uart flag
#define GUF(   )		(UART.UF)				 //
